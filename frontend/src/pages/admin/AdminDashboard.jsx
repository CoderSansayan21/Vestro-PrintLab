    ...
    <NeonCard className="p-5">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-3 text-4xl font-black text-vestro-text">{value}</p>
        </div>
  ...
  return (
    <main className="min-h-screen bg-vestro-page text-vestro-text">
      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-[280px_1fr]">
        <aside
          className={`fixed inset-y-0 left-0 z-50 w-72 border-r border-vestro-cyan/15 bg-vestro-secondary/95 p-4 shadow-vestro-sm backdrop-blur-xl transition-transform duration-200 lg:static lg:w-auto lg:translate-x-0 ${
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <h1 className="truncate text-2xl font-black text-vestro-text sm:text-3xl">Operations Overview</h1>
                </div>
              </div>
              ...
              <NeonCard>
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <h2 className="mt-2 text-2xl font-black text-vestro-text">Order queue</h2>
                  </div>
              ...
              <NeonCard>
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <h2 className="mt-2 text-2xl font-black text-vestro-text">Apparel overview</h2>
                  </div>
                  <StatusBadge variant="info">Inventory</StatusBadge>
                </div>
                <div className="mt-5 grid gap-3">
                  {productStatuses.map((item) => (
                    <div key={item.label} className="flex items-center justify-between rounded-xl border border-vestro-border bg-vestro-elevated/70 px-4 py-3">
              ...
              <NeonCard>
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <h2 className="mt-2 text-2xl font-black text-vestro-text">Production states</h2>
                  </div>
              ...
              <NeonCard>
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <h2 className="mt-2 text-2xl font-black text-vestro-text">Insights</h2>
                  </div>
